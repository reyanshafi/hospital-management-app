  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {particles.map((particle) => (
        <div
          key={particle.id}
          className="absolute bg-blue-400/15 rounded-full animate-pulse"
          style={{
            left: `${particle.x}%`,
            top: `${particle.y}%`,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/3 left-1/2 w-80 h-80 bg-gradient-to-br from-emerald-300/15 to-blue-400/15 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
        ...
        <div className="absolute bottom-32 left-20 w-28 h-28 border border-indigo-200/40 rounded-full animate-spin" style={{ animationDuration: '18s', animationDirection: 'reverse' }}></div>
        <div className="absolute top-1/2 right-10 w-16 h-16 border-2 border-blue-300/30 rotate-45 animate-pulse"></div>
      ...
      <div className="relative z-10 min-h-screen grid lg:grid-cols-2 gap-8">
        {/* Left Side - Header Content */}
        <div className="flex flex-col justify-center items-start px-6 lg:px-16 py-12">
          <div className="w-full max-w-lg">
            ...
            <div className="mb-12">
              <div className="flex items-center mb-8">
                <div className="relative group cursor-pointer">
                  ...
                  <div className="relative bg-gradient-to-br from-white/25 to-white/10 backdrop-blur-2xl border border-white/30 p-6 rounded-3xl shadow-2xl group-hover:shadow-3xl transform group-hover:scale-105 transition-all duration-700">
                    {/* 3D medical icon */}
                    <div className="relative">
                      <svg 
                        className="w-12 h-12 text-blue-600 drop-shadow-2xl transform group-hover:rotate-12 transition-transform duration-700" 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                        strokeWidth={1.5}
              ...
              <div className="space-y-6">
                <div className="relative">
                  <h1 className="text-5xl lg:text-6xl font-black bg-gradient-to-r from-gray-900 via-blue-800 to-indigo-900 bg-clip-text text-transparent leading-tight tracking-tight">
                    MediCare
                  </h1>
                  <div className="text-3xl font-light bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mt-2">
                    Portal
                  </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="h-px w-20 bg-gradient-to-r from-transparent via-blue-500 to-transparent opacity-60 animate-pulse"></div>
                  <div className="px-6 py-3 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl border border-blue-200/50 shadow-lg">
                ...
                <p className="text-gray-700 font-light text-2xl leading-relaxed">
                  Your secure gateway to comprehensive healthcare management and patient care coordination.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-6 text-sm">
                <div className="flex items-center space-x-3 px-5 py-3 bg-green-50/80 backdrop-blur-sm rounded-2xl border border-green-200/60 shadow-md">
                  <div className="relative">
                ...
                <div className="flex items-center space-x-3 px-5 py-3 bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-200/60 shadow-md text-gray-700">
        ...
        <div className="flex flex-col justify-center items-center px-6 lg:px-16 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/85 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/60 p-8 group-hover:shadow-3xl group-hover:bg-white/90 transition-all duration-700">
                <LoginForm />
              </div>
            </div>
          </div>
